...
**Level 1**: Single-file scripts, run once and inspect output  
...
**Level 1**: Static prompts with compressed data  
...
**Level 1**: Read output, judge quality manually  
