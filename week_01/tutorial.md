...
- [01 — Agent Tools Overview: concepts + landscape](01_agent_tools_overview.md)
- [02 — ChatGPT and Claude Basics](02_chatgpt_claude_basics.md)
- [03 — Cursor Editor Introduction](03_cursor_intro.md)
- [04 — Kilo Guide: terminal-based AI assistant](04_kilo_guide.md)
- [05 — AI Tools Comparison: when to use which](05_ai_tools_comparison.md)
...
1. **Concepts first**
    - Understand what AI agents are before diving into specific tools.
    - What to verify: you can explain "what is an AI agent" to someone else.

2. **Browser-based tools second**
